...
from nydrive_map_compiler.adapters.nyc_dcm import normalize_dcm_geojson
...
def test_dcm_native_epsg2263_fields_are_preserved_and_width_becomes_meters():
    road = normalize_dcm_geojson(load("dcm_centerline.geojson"), source_revision="2024-03-31")[0]
